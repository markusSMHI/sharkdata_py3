...
#             
#             
#         if 'processed_data/metadata.txt' not in self._zip.namelist():
#             raise UserWarning('The entry processed_data/metadata.txt is missing in ' + self._filepathname)
#         #    
#         return self._zip.open('processed_data/metadata.txt').read()
