...
class DarwinCoreDataHarbourSeal(darwincore_data_base.DarwinCoreDataBase):
    """ """
    def __init__(self):
        """ """
        #
        super(DarwinCoreDataHarbourSeal, self).__init__()
        #
    ...
    def add_extra_fields(self, row_dict):
        ...
        row_dict['collection_code'] = 'SHARK HarbourSeal'
...
#                         ('time', 'sample_time'), 
            ...
            dwca_visit_id_short = 'SharkHarbourseal-EVENT-' + str(self.dwca_visit_id_short_names.index(dwca_visit_id) + 1)
