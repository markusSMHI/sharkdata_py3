...
class DarwinCoreDataBacterioplankton(darwincore_data_base.DarwinCoreDataBase):
    """ """
    def __init__(self):
        """ """
        #
        super(DarwinCoreDataBacterioplankton, self).__init__()
        #
    ...
    def add_extra_fields(self, row_dict):
        ...
        row_dict['collection_code'] = 'SHARK Bacterioplankton'
...
#             row_dict['year'] = sample_date_str[0:4]
    ...
    def create_extra_keys(self, row_dict):
        ...
        dwca_visit_id_short = 'EVENT-' + str(self.dwca_visit_id_short_names.index(dwca_visit_id) + 1)
...
### SHARK header for the datatype Bacterioplankton:
# delivery_datatype
# check_status_sv
# data_checked_by_sv
# visit_year
