...
#         filter_file_path = pathlib.Path('D:/arnold/4_sharkdata\sharkdata_ftp/resources/export_ices_filters.txt')
        filter_file_path = pathlib.Path('D:/arnold/4_sharkdata/notebooks/test_data/SHARKdata_resources/export_ices_filters.txt')
...
#         translate_file_path = pathlib.Path('D:/arnold/4_sharkdata\sharkdata_ftp/resources/translate_dyntaxa_to_worms.txt')
        translate_file_path = pathlib.Path('D:/arnold/4_sharkdata/notebooks/test_data/SHARKdata_resources/translate_dyntaxa_to_worms.txt')
