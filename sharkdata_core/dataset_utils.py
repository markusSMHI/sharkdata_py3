...
class DatasetUtils(object):
    ...
    def __init__(self):
        ...
        self._data_in_datasets = pathlib.Path(settings.SHARKDATA_DATA_IN, 'datasets')
...
#                         'uploaded_datetime': '', 
    ...
    def getDataAsText(self, dataset_name):
        ...
        # Extract data part.
        data_content = ''
        zipreader = sharkdata_core.SharkArchiveFileReader(db_dataset.dataset_file_name, self._data_in_datasets)
        try:
            zipreader.open()
...
#                     file_path.unlink() # Removes file.
    ...
    def writeFileInfoToDb(self, file_name, logfile_name = None, user = ''):
        ...
        try:
            ...
            #
            zipreader = sharkdata_core.SharkArchiveFileReader(file_name, self._data_in_datasets)
            try:
                zipreader.open()
                #
                try:
