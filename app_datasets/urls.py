...
urlpatterns = [
    ...
    path('<str:dataset_name>/data_columns.txt/', app_datasets.views.datasetDataColumnsText),
    path('<vdataset_name>/data_columns.json/', app_datasets.views.datasetDataColumnsJson),
    #
...
#     path('<str:dataset_name>/metadata.xml/', app_datasets.views.datasetMetadataXml),
    ...
    path('<str:dataset_name>/dwc_archive.zip/', app_datasets.views.dwcArchiveZip),
    path('<str:dataset_name>/dwc_archive_eurobis.zip/', app_datasets.views.dwcArchiveEurobisZip),
    path('<str:dataset_name>/dwc_archive_sampledata.zip/', app_datasets.views.dwcArchiveSampledataZip),
